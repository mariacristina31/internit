                    ...
                    <form enctype="multipart/form-data" onsubmit="return confirm('Do you want to save this data?');" method="POST" action="{{ route('company.store') }}">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                ...
                                <input autocomplete="off" class="form-control" id="autocomplete" name="address" value="{{ old('name') }}" type="text"></input>
                            </div>
                            <div class="form-group">
                                <label for="lat">Latitude</label>
                                <input type="text" readonly class="form-control" name="lat" id="lat">
                            </div>
                            <div class="form-group">
                                <label for="lng">Longitude</label>
                                <input type="text" readonly class="form-control" name="lng" id="lng">
                            </div>
                            <div class="form-group">
